...
#1Todos los años que se dividen exactamente entre 400, o que son divisibles 
...
#2Dado un número entero cuya cantidad de dígitos es igual a 5, determine si es capicúa.
 def ejercicio2(self):
...
#3Cree un algoritmo que tome por entrada las horas y minutos de un día y dé como resultado su equivalente en segundos.
 def ejercicio3(self):
    ...
    print(t)
#4Para un valor entero positivo que representa una cantidad en segundos, indicar su equivalente en minutos, horas y días.
 def ejercicio4(self):
...
#5Dados tres números enteros positivos A, B y C, determine ¿cuál de ellos es el mayor? y ¿cuál es el segundo mayor?        
 def ejercicio5(self):
        abc=['1','2','3']
        lista=[0]*3
        indice=0
...
#7 El IMC resulta de la división de la masa del individuo (en kilogramos) entre el
...
#8 Escriba un algoritmo que reciba una fecha (día y mes) correspondiente al año 
...
#9Solicitar un número entre el 1 y el 12 e imprimir el mes correspondiente a dicho 
#número.
 def ejercicio9(self):
     if __name__ == '__main__':
      print("Ingrese Número del Mes (1 - 12) : ")
     ...
     if num==1:
          ...
          print("NÚMERO DEL MES INCORRECTO")            
#10En un almacén se hace un 20% de descuento a los clientes cuya compra supere

...
#1Dado un número entero N, calcular e informar al usuario cuántos dígitos tiene dicho número.
  def ejercicio1(self):
    num = int(input("Ingresa un numero: "))
    contador = len(str(num))
    print("El numero tiene %s digitos" % (contador)) 
    
#2Dado un número, determine si es capicúa
  def ejercicio2(self):
...
#3Dado un número N determinar si es un número primo.
  def ejercicio3(self):
...
#4Construya un programa que dado un valor entero N, haga el cálculo de la función factorial utilizando estructuras iterativas.        
  def ejercicio4(self):  
...
#5Dado un número entero N que representa una contraseña y asumiendo que una
  ...
  def ejercicio5(self):
        ...
        while validacion==False:
            ...
            if len(clave)==10:
                ...
                validacion=False 
#6Dada una secuencia de números terminada en cero (0), elaborar un algoritmo que
...
#7Se tiene una secuencia de enteros terminada en cero, que corresponde a la edad,
...
#8Construye un algoritmo que calcule e imprima la tabla de multiplicar, desde la tabladel 1 hasta la del 10.
  def ejercicio8(self):
       numero = int(input("ingrese numero: "))
       for i in range(1 , 11):
           resultado = i * numero
           print(numero,"x", i, "=", resultado)
#9Escribir un algoritmo que muestre todas las fichas de dominó, sin repetir.         
  def ejercicio9(self):
        for i in range(0,7):
            for j in range(0, i+1):
                print("|" + str(i) + "|" + str(j) + "|")

#10Dados N número positivos (N>1) calcular el promedio de esta serie. Considere que la serie termina al leer un 0.          

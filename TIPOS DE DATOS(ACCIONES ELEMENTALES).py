...
class deber:
    ...
    #1¿De cuál tipo de dato sería la variable donde almacena lo siguiente?
    def ejercicio1(self):
    ...
    #2Siguiendo la prioridad de operadores, convierta a expresión matematica, resuelva e indique
    #en cual tipo de variable almacenará el resultado de las siguientes expresiones.
    def ejercicio2(self):
    ...
    #3Dados dos (2) números calcule la suma, resta, multiplicación, división y módulo.
    ...
    #4Dados tres (3) números, Hacer una aplicación que calcule la resolvente
    # x2 - 9x + 8 = 0
    ...
    #5Dados dos (2) lados de un triángulo en cm, calcular la hipotenusa del mismo.
    def ejercicio6(self):
         import math
         ...
         print(resultado)   
    #6Dado un (1) número, imprimir 0 si es par y 1 si es impar.
    def ejercicio7(self):
    ...
    #7dado un (1) número binario de cuatro (4) dígitos imprimir su bit da paridad. El bit
    ...
    #8Dado un (1) número binario de cuatro (4) dígitos imprimir su valor   
    def ejercicio10(self):
        ...
        pass
    #9Dado un (1) número de cuatro (4) dígitos imprimirlo por separado en unidades,

...
#1Construya una función que solicite edades al usuario y determine el promedio de
...
#2Construya una función “Eleva” Que reciba como parámetros una base y un
...
#3Escriba una función que calcule el perímetro del pentágono (siendo el perímetro la suma de los lados del polígono)    
 def ejercicio3(self):
        lado=float(input("Ingrese un lado del pentágono!:"))
        perimetro=5*lado
        print( perimetro)
#4En una empresa pagan según las horas trabajadas y una tarifa fija por hora. Si la
...
#principal.
 def ejercicio4(self):
        ...
        if len(conc)==3:
            ...
            print(f"{empleados[12]}:\nNo realizo horas extras.\nIngreso total de la semana: ${conc[0]}\n")
#5Escriba una acción (MillasAKilometros) que convierta una distancia en millas a
